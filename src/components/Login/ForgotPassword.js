...
class ForgotPassword extends React.Component {
	...
	async postData() {
		...
		try {
			const results = await fetch('/forgotpassword', {
				crossDomain: true,
				method: 'POST',
				headers: {
					...
					<div className={classes.paper}>
						...
						<form className={classes.form} noValidate>
							...
							<Select
								...
								variant="outlined"
							>
								<MenuItem className={classes.drop} value="Applicant">Applicant</MenuItem>
								<MenuItem className={classes.drop} value="Employer">Employer</MenuItem>
							</Select>
							<Button
								type="submit"
								fullWidth
